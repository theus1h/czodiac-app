...
import { TIGERHUNT_ADDRESSES } from "@constants/index"
import { Contract, utils, BigNumber } from "ethers"
import useDeepCompareEffect from "./useDeepCompareEffect"
import tigerHuntAbi from "@contracts/abis/tigerHunt.json"
...
function useTigerHunt() {
  ...
  const { state: doEatSleepDrinkPoopState, send: doEatSleepDrinkPoopSend } = useContractFunction(
    tigerHuntContract,
    "doEatSleepDrinkPoop"
  )
