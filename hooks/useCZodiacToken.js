...
import { useEthers, useContractFunction } from "@pdusedapp/core"
import { Contract, utils } from "ethers"
import czodiacTokenAbi from "@contracts/abis/czodiacToken.json"
...
function useCZodiacToken(address) {
  ...
  const [czContract, setCzContract] = useState(null)
  ...
  useEffect(() => {
    if (!!account && !!address) setCzContract(new Contract(address, czodiacTokenInterface))
