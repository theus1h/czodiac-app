    ...
    ;(async () => {
      if (!!busdPair && "0x0000000000000000000000000000000000000000" != busdPair) {
        ...
        if (busdBalance.gt(parseEther("10000")) || !wbnbPair) {
          ...
          setPrice(busdBalance.mul(parseEther("1")).div(tokenBalance))
          return
        }
      }
      if (
        !!wbnbPair &&
        "0x0000000000000000000000000000000000000000" != wbnbPair &&
        !!bnbBusdPair &&
        "0x0000000000000000000000000000000000000000" != bnbBusdPair
      ) {
        ...
        setPrice(bnbBalance.mul(parseEther("1")).div(tokenBalance).mul(busdBalanceOfBNB).div(bnbBalanceOfBNB))
        return
      }
      setPrice(null)
    })()
